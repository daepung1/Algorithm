...
def solution(survey, choices):
    ...
    for i in range(len(choices)):
        if choices[i]==4:
            ...
            point=1
            if state=='A':
                A_point=A_point+point
            elif state=='N':
                N_point=N_point+point
            elif state=='C':
                C_point=C_point+point
            elif state=='F':
                F_point=F_point+point
            elif state=='J':
                J_point=J_point+point
            elif state=='M':
    ...
    if R_point>=T_point :
        answer=answer+'R'
    elif R_point<T_point:
        answer=answer+'T'
    if C_point>=F_point :
        answer=answer+'C'
    elif C_point<F_point:
        answer=answer+'F'
    if J_point>=M_point :
        answer=answer+'J'
    elif J_point<M_point:
        answer=answer+'M'
    if A_point>=N_point :
        answer=answer+'A'
    elif A_point<N_point:
        answer=answer+'N'
    return answer
#[an cf rt jm]
state=''
